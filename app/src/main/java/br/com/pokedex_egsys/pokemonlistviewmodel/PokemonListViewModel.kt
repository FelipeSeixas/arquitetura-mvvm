...
import br.com.pokedex_egsys.data.models.PokedexListEntry
...
class PokemonListViewModel @Inject constructor(
    ...
    // Método para buscar Pokémons por nome ou tipo
    fun searchPokemon(query: String) {
        viewModelScope.launch {
            val pokemons = repository.getPokemonInfo(query)
//            pokemonList.value = pokemons
    ...
    fun getRandomPokemon() {
        // Implemente aqui a lógica para obter um Pokémon aleatório
    }
